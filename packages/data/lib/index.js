...
class DataManager {
            ...
            if (!locationProperties || locationMatched) {
                        ...
                        if (audiences.length) {
                            ...
                            if (matchedAudiences.length) {
                                for (const item of matchedAudiences) {
                                    (_b = (_a = this._loggerManager) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.call(_a, jsSdkEnums.MESSAGES.AUDIENCE_MATCH.replace('#', (item === null || item === void 0 ? void 0 : item.id) || (item === null || item === void 0 ? void 0 : item.key)));
                                }
                            }
                        }
                        ...
                        if (segmentations.length) {
                            ...
                            if (matchedSegmentations.length) {
                                for (const item of matchedSegmentations) {
                                    (_d = (_c = this._loggerManager) === null || _c === void 0 ? void 0 : _c.info) === null || _d === void 0 ? void 0 : _d.call(_c, jsSdkEnums.MESSAGES.SEGMENTATION_MATCH.replace('#', (item === null || item === void 0 ? void 0 : item.id) || (item === null || item === void 0 ? void 0 : item.key)));
                                }
                            }
                        }
                    }
                ...
                if (!visitorProperties ||
                    ...
                    if ((experience === null || experience === void 0 ? void 0 : experience.variations) && ((_e = experience === null || experience === void 0 ? void 0 : experience.variations) === null || _e === void 0 ? void 0 : _e.length)) {
                        ...
                        (_g = (_f = this._loggerManager) === null || _f === void 0 ? void 0 : _f.info) === null || _g === void 0 ? void 0 : _g.call(_f, jsSdkEnums.MESSAGES.VARIATIONS_NOT_FOUND);
                        // eslint-disable-line
                    }
                }
                else {
                    (_j = (_h = this._loggerManager) === null || _h === void 0 ? void 0 : _h.info) === null || _j === void 0 ? void 0 : _j.call(_h, jsSdkEnums.MESSAGES.AUDIENCE_NOT_MATCH);
                    // eslint-disable-line
                }
            }
            else {
                (_l = (_k = this._loggerManager) === null || _k === void 0 ? void 0 : _k.info) === null || _l === void 0 ? void 0 : _l.call(_k, jsSdkEnums.MESSAGES.LOCATION_NOT_MATCH);
                // eslint-disable-line
            }
        }
        else {
            (_o = (_m = this._loggerManager) === null || _m === void 0 ? void 0 : _m.info) === null || _o === void 0 ? void 0 : _o.call(_m, jsSdkEnums.MESSAGES.EXPERIENCE_NOT_FOUND);
            // eslint-disable-line
        }
        return null;
    }
    ...
    _retrieveBucketing(visitorId, experience) {
        ...
        if (variationId &&
            ...
            (_b = (_a = this._loggerManager) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.call(_a, jsSdkEnums.MESSAGES.BUCKETED_VISITOR_FOUND.replace('#', `#${variationId}`));
            // eslint-disable-line
        }
        else {
            ...
            if (variationId &&
                ...
                // If it's found log debug info. The return value will be formed next step
                (_f = (_e = this._loggerManager) === null || _e === void 0 ? void 0 : _e.info) === null || _f === void 0 ? void 0 : _f.call(_e, jsSdkEnums.MESSAGES.BUCKETED_VISITOR_FOUND.replace('#', `#${variationId}`));
                // eslint-disable-line
            }
            else {
                ...
                if (variationId) {
                    (_h = (_g = this._loggerManager) === null || _g === void 0 ? void 0 : _g.info) === null || _h === void 0 ? void 0 : _h.call(_g, jsSdkEnums.MESSAGES.BUCKETED_VISITOR.replace('#', `#${variationId}`));
                    // Store the data in local variable
            ...
            for (let i = 0, length = items.length; i < length; i++) {
                ...
                if (match === true) {
                    ...
                    if (!locations.includes(identity)) {
                        ...
                        (_l = (_k = this._loggerManager) === null || _k === void 0 ? void 0 : _k.info) === null || _l === void 0 ? void 0 : _l.call(_k, jsSdkEnums.MESSAGES.LOCATION_ACTIVATED.replace('#', `#${identity}`));
                    }
                    ...
                    (_r = (_q = this._loggerManager) === null || _q === void 0 ? void 0 : _q.info) === null || _r === void 0 ? void 0 : _r.call(_q, jsSdkEnums.MESSAGES.LOCATION_DEACTIVATED.replace('#', `#${identity}`));
                }
            }
        }
        // Store the data in local variable
