    ...
    setCustomSegments(visitorId, segments, segmentRule) {
        ...
        for (const segment of segments) {
            if (segmentRule && !segmentsMatched) {
                segmentsMatched = this._ruleManager.isRuleMatched(segmentRule, segment === null || segment === void 0 ? void 0 : segment.rules, `Segments #${segment === null || segment === void 0 ? void 0 : segment.id}`);
