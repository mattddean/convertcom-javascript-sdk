...
class RuleManager {
    ...
    isRuleMatched(data, ruleSet, logEntry) {
        ...
        // eslint-disable-line
        if (logEntry) {
            (_b = (_a = this._loggerManager) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.call(_a, jsSdkEnums.MESSAGES.PROCESSING_ENTITY.replace('#', logEntry));
        }
        // Top OR level
        let match;
                ...
                if (this.getComparisonProcessorMethods().indexOf(matching) !== -1) {
                    if (typeof data === 'object') {
                        ...
                        if (data.constructor === Object) {
                            ...
                            (_b = (_a = this._loggerManager) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.call(_a, jsSdkEnums.MESSAGES.RULE_MATCH_START.replace('#', rule.rule_type));
